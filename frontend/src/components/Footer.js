        ...
        <div id="footer" style={{display:"flex", justifyContent:"space-evenly", alignItems:"center"}}>
            <div>
                ...
                <div><img src={img1} style={{ width: "50px", marginTop: "15px" }} className="icons"></img>
                    <img src={img2} style={{ width: "50px", marginTop: "15px" }} className="icons"></img>
                    <img src={img3} style={{ width: "50px", marginTop: "15px" }}  className="icons"></img>
                </div>
            </div>
            <div  id="col1"  >
                ...
                <div style={{ display: "flex", alignItems: "center" }}>
                    <img src={img4} style={{ width: "25px",  }}></img>
                    <p style={{fontSize:"25px", margin:"0 10px"}}>42574259</p>
                </div>
                <div style={{ display: "flex", alignItems: "center" }}>
                    <img src={img5} style={{ width: "25px",  alignItems: "center" }}></img>
